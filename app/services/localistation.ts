const TRANSLATIONS: Record<string, Record<string, string>> = {
    en: {
        ...
        free_bandwidth: "Limited bandwidth (300MB/day)",
    ...
    ru: {
        ...
        free_bandwidth: "Ограничение трафика (300МБ/день)",
    ...
    es: {
        ...
        free_bandwidth: "Ancho de banda limitado (300MB/día)",
    ...
    ar: {
        ...
        free_bandwidth: "عرض نطاق محدود (300 ميجابايت/يوم)",
    ...
    pt: {
        ...
        free_bandwidth: "Largura de banda limitada (300MB/dia)",
